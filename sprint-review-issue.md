# Sprint Review – Issue-tekst for GitHub

**Lenke for å opprette nytt issue:**  
https://github.com/sevarianto/nordicfitness-timetable-frontend/issues/new

---

## Tittel (copy-paste i "Title"-feltet):
```
sprint-review: Sprint 1 gjennomgang
```

---

## Beskrivelse (copy-paste i beskrivelsesfeltet):
